...
sealed interface HirType
{
    ...
    /**
     * The literal type describes a function-like object which must return exactly a value object, and must take exactly
     * one parameter object. This is used to describe a transformation function which goes from a builtin data type, to
     * a specific user-defined type.
     *
     * Example syntax: `lit(Int32) -> Bool`
     *
     * @param value The type which is permitted to be returned as a value.
     * @param parameter The type of the parameter which the function requires.
     */
    data class Literal(val value: HirType, val parameter: Structure) : HirType
