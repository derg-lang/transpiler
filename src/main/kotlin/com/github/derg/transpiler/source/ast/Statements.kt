 ...
 */
data class AstBranch(val predicate: AstExpression, val success: List<AstStatement>, val failure: List<AstStatement>) : AstControl
 ...
 */
data class AstReturnError(val expression: AstExpression) : AstControl
